...
\end{itemize}
The above constructions are not $\PP$-functors (but exposures~\cite{Kavvos2017b}) so that congruence (the preservation of extensional equality) is not imposed by definition and is even shown false.

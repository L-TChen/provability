...
Even further, we can restrict to closed elements as given by~\Cref{lem:global-element}.
...
There is a family of functions $\bproj{\delta_X}(M, x, r) \defeq (\qquote{M}, (M, x, r), \refl_\twoheadrightarrow)$ from $\bproj{\boxtimes X}$ to $\bproj{{\boxtimes} {\boxtimes} X}$ tracked by~$\mathtt{quote}$ which quote closed elements of~$\boxtimes X$.
%  \[

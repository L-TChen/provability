...
Similar to~\Cref{thm:S4-no-quoting}, the computational meaning of $A \to \Box^\kappa A$ cannot be quoting.
...
Our work is also partly inspired by Shamkanov's~\cite{Shamkanov2014, Shamkanov2016a} provability semantics for \GL using circular proofs.

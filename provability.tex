...
For categorical semantics where terms are interpreted as morphisms, an interpretation into a $\PP$-category is able to discriminate these two kinds of identities, enabling us to model intensionality.

We recall the notion of exposures.
An exposure is like a $\PP$-functor but it does not preserve $\sim$-equality.%
\hsnote{Some more explanation here}
...
\hsnote{$\PP$-terminality/initiality etc}

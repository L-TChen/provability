...
\ltnote{not in the sense of Kelly}
...
\begin{example}\label{ex:assembly-lambda}
  ...
  \ltnote{identified up to $\beta$-equality, no induction principle}
\end{example}
...
\ltnote{categorical simulations}
\end{remark}
...
\section{An exposure for the \texorpdfstring{\GL}{GL} modality}
...
\subsection{Back to \texorpdfstring{\GL}{GL}} \label{sec:GL}

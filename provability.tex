...
\begin{itemize}
    ...
    By working in guarded type theory, $\Box X \to X$ can no longer be validated by projection (because the value~$x$ from $(M, x)$ is only available later) and is actually impossible; also intensional recursion can be modelled by guarded recursion.
\end{itemize}

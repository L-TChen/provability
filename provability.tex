...
Therefore, there have been investigations into type-theoretic foundations for staged computation with modalities~\cite{Davies2017,Davies2001b,Nanevski2008,Kavvos2017a}, which have influenced the design of practical implementations~\cite{Taha2000,Sheard2002,Kiselyov2014} to varying degrees.
\ltnote{cite more?}
...
\end{itemize}
The above constructions do not give $\PP$-functors (but exposures~\cite{Kavvos2017b}) so that congruence (the preservation of extensional equality) is not imposed by definition and is even shown false.
Hence, our denotational semantics is precise enough to capture the essence of intensionality by refuting internal quoting and congruence, which previous work~\cite{Gabbay2013,Kavvos2017b} fails to achieve.%
\ltnote{Ask Kavvos}
...
We then show that it satisfies the deductive form of the Gödel-Löb axiom---the intensional recursion.

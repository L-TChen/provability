...
Unfortunately, when $\mathtt{Code}$ is designed in this way, a contradiction is derivable, making it impossible to treat it as a logical foundation.
...
Besides the use of set theory as the metalanguage for the development, the exposure $\boxtimes_K$ differs from~$\boxtimes$ in a many ways.

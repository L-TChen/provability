...
The construction of exponential $X \Rightarrow Y$ is a bit laborious.
With the definition of trackable maps, we may expect the exponential $X \Rightarrow Y$ to consist of trackable maps.
...
\begin{example}[Exponential]
  ...
  The \emph{curried map} of a trackable function $(f, F, \mathfrak{f}) \colon Z \times X \to Y$ consists of
  \begin{enumerate}
    \item a function
...
In short, we have classic properties of the category $\Asm(\Lambda)$:
\begin{corollary}
